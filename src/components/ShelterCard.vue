    ...
    <div class="card-content">
      ...
      <div class="card-actions">
        <template v-if="isClinic">
          <button class="action-contact action-route-clinic">Rute</button>
          <button class="action-detail action-contact-clinic">Hubungi</button>
        </template>
        <template v-else>
          <button class="action-detail">Lihat Detail</button>
          <button class="action-contact">Hubungi</button>
        </template>
      </div>
    </div>
  </div>
