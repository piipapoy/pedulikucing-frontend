        ...
        <div class="column-right">
          <InfoCard>
            ...
            <div class="button-group">
              ...
              <BaseButton variant="outline" @click="showLoginModal = true">Hubungi Shelter</BaseButton>
            </div>
          </InfoCard>
...
export default {
  ...
  data() {
    return {
      ...
      cat: {
        name: 'Bella',
        story: 'Bella adalah kucing cantik yang ditemukan dalam kondisi malnutrisi di area parkir kantor. Setelah dirawat intensif selama 3 bulan, Luna kini telah pulih sepenuhnya dan siap menemukan keluarga yang akan menyayanginya selamanya. Dia sangat manja dan suka bermain, cocok untuk keluarga dengan anak-anak.',
        images: [
  ...
  methods: {
    goToAdoptionForm() {
      // Nanti kita arahkan ke halaman form
      // this.$router.push('/adopsi/bella/form') 
      alert('NAVIGASI KE FORM ADOPSI!')
    }
  }
}
</script>
